...
在 =hugo v0.81.0= 以及之后，使用的 =go-org= 依赖升级到了 =v1.4.0= 版本，使用相对路径的引用都会默认加上 =../= 前缀，所以用默认生成的地址就可以了，而不需要在文档的头信息中添加 =url= 信息，具体可以查看该 [[https://github.com/gohugoio/hugo/pull/8111][pull request]] 。

[[./images/org_blog_with_hugo_2.jpg]]
...
经过测试，hugo 在 [[https://github.com/gohugoio/hugo/releases/tag/v0.83.0][0.83.0]] 版本将 go-org 依赖升级到了 v1.5.0 后，使用相对路径的引用都会默认加上 =../= 前缀这个特性已经没了。
