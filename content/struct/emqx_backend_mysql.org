...
#+date: 2020-10-16T17:04:16+08:00
#+tags[]: iot emqx
#+categories[]: struct
#+draft: true
...
linux 系统可以使用 kerl 脚本安装，构建最新版本的 emqx 时注意编译的 gcc 版本不能用 10，编译通不过，推荐用 gcc-9
...
[[file:http://minio.gobuildrun.com/knowledgebase-service/13f84bdb-772d-4350-8d29-be96431ce5ae/blob.png]]
...
[[file:http://minio.gobuildrun.com/knowledgebase-service/f0c50f8a-a34e-4a3d-a53b-0415ddf9d2a5/blob.png]]
...
#+end_src
如果启用失败，可以查看日志文件 =log/emqx.log.1=
启用成功后，可以根据 [[https://docs.emqx.net/enterprise/latest/cn/rule/rule-example.html#%E4%BB%8E-pulsar-%E6%B6%88%E8%B4%B9%E6%B6%88%E6%81%AF%E5%88%B0-emq-x][官方文档]] 来测试该插件
