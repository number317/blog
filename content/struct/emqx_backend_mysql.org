...
#+summary: 关于 emqx 的编译，插件的构建，官方 emqx_backend_mysql 插件的获取
#+author: cheon
...
[[file: /struct/images/emqx_backend_mysql_1.png][diff]]
...
[[file: /struct/images/emqx_backend_mysql_2.png][enable mysql plugin]]
